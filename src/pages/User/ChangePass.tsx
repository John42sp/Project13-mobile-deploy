...
export default function ChangePass() {
  ...
  const navigation = useNavigation();
    ...
    await api.post('/users/changepass', { email, password, newPassword })
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 24 }}>
      ...
      <Text style={styles.label}>Digite senha atual</Text>
      <TextInput
      ...
      <RectButton style={styles.nextButton} onPress={handleChangePass}>
